	...
	function photoClip(container, option) {
        ...
        function jrimage(f){
            if(app.device.ios){
                ...
                app.compress(file, {maxWidth:app.device.width, maxHeight: app.device.height, quality: .9, type:'jpeg'}, function (dataUrl,paramValue) {
                    //param =  paramValue;
//                $("#div_pztps > img").attr("src",dataUrl);
//                $("#div_pztp > img").attr("src",dataUrl);
//                //$("#video").show();
//                $("#div_pztp > img").load(function(){
//                    if(sjs==7){
//                        $("#page2").show();
//                    }else{
//                        $("#page3").show();
...
//                });
        ...
        function androidImage(file,sjs){
...
//                $("#div_pztps > img").attr("src",evt.target.result);
//                $("#div_pztp > img").attr("src",evt.target.result);
//                //$("#video").show();
//                $("#div_pztp > img").load(function(){
//                    if(sjs==7){
//                        $("#page2").show();
...
//                    //submitimage(sjs)
//                });
                    createImg(evt.target.result);
                }
                reader.readAsDataURL(file.files[0]);
            }
            else
            {
                //console.log("error||取消了照片选择")
            }
        }
